    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-xl p-8">
          <h2 className="text-xl font-bold text-text-main mb-2">Iniciar Sesión</h2>
          <p className="text-text-muted text-sm mb-6">Accede a tu cuenta para continuar</p>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white px-4 text-text-muted">o continúa con</span>
            </div>
          </div>

          <button
            onClick={handleGoogleLogin}
            className="w-full h-12 bg-white border border-slate-200 text-text-main font-medium rounded-xl hover:bg-slate-50 transition-colors flex items-center justify-center gap-3"
          >
          ...
          <p className="text-center text-sm text-text-muted mt-6">
            ¿No tienes cuenta?{' '}
            <a href="/register" className="text-primary font-medium hover:underline">Regístrate</a>
          </p>
        </div>
      </div>
    </div>
